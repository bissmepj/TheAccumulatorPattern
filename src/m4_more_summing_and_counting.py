...
def run_test_count_cosines_from():
    ...
    expected = 0
    answer = count_cosines_from(2, 14, 1)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    expected = 2
    answer = count_cosines_from(0, 4, 0.50)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    expected = 891
    answer = count_cosines_from(10, 900, -1)
...
def run_test_sum_unit_fractions_from():
    ...
    expected = 0.510353  # This is APPROXIMATELY the correct answer.
